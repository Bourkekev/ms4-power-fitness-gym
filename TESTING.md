...
I validated the rendered html of all pages with the [W3C Markup Validation Service](https://validator.w3.org/) and I had to deal with the following issues:
 ...
 - It showed me some errors like a wrong closing tags, that certain attributes should not be on the iframes, duplicate ids in one page. 
...
The multiselect field used for the products sizes is showing an error with blank 'for' and 'class' attributes. This is being generated by the Multiselect Field add-on from the model, and to fix this I may need to customize the HTML of this widget in the form template, but time constraints prevented me from investigating and fixing this at the moment.
