...
ALLOWED_HOSTS = ['power-fitness.herokuapp.com', '31fd933863ac.ngrok.io', '127.0.0.1', 'localhost']
...
if 'DEVELOPMENT' in os.environ:
    ...
    DOMAIN_URL = 'https://power-fitness.herokuapp.com/'
...
STRIPE_PLAT_PRICE_ID = os.getenv('STRIPE_PLAT_PRICE_ID', '')
